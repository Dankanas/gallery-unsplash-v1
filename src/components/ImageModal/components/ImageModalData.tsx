  ...
  return (
    <div className={`${className}`}>
      <div className={`${className}__block`}>
        <div className={`${className}_icon`}><Icon name="heart" color={theme === "light" ? "dark" : "light"}/></div>
        <div className={classNameValue}>{likes}</div>
      </div>
      <div className={`${className}__block`}>
      <div className={`${className}_icon`}><Icon name="download" color={theme === "light" ? "dark" : "light"}/></div>
        <div className={classNameValue} id="value_downloads">
          {downloads}
        </div>
      </div>
      <div className={`${className}__block`}>
      <div className={`${className}_icon`}><Icon name="eye" color={theme === "light" ? "dark" : "light"}/></div>
